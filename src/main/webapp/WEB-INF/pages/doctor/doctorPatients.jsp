...
<div id="wrapper">
    ...
    <table>
        <tr>
            <th><form action="/Hospital/add_patient" method="post">
                <td><input type="submit" class="button" value=<fmt:message key="add_patient" /> ></td>
            </form></th>
            <th><form action="/Hospital/get_patients_for_remove_patient" method="post">
                <td><input type="submit" class="button" value=<fmt:message key="remove_patient"/> ></td>
            </form></th>
            <th><form action="/Hospital/hospitalize_patient" method="post">
